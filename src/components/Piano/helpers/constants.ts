...
export const RIGHT_PADDING_FACTOR =
  lastNote === "E" || lastNote === "B" ? 0 : 1;

const TOTAL_PADDING =
  (LEFT_PADDING_FACTOR + RIGHT_PADDING_FACTOR) * KEY_PADDING;

export const KEY_WIDTH_CSS = (total: number) =>
  `(100% / (${total} + ${TOTAL_PADDING}))`;
